...
export default function Hero() {
    return (
        <div className="flex flex-col pt-18 max-w-[1024px] w-full mx-auto gap-8 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <div className="flex flex-row items-center rounded-xl hover:bg-neutral gap-x-1.5 px-4 py-2.5 reveal-blur reveal-blur-delay-3">
                    <div className="text-stone text-sm font-medium bg-gradient-to-r from-sand to-stone bg-clip-text text-transparent">Introducing Sub-Teams</div>
